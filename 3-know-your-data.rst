...
1) Limit the search results to split the pages to several pages::
    ...
    curl -sku <username:password> "https://<testing-instance>/api/2.0/urn:uuid:68320fee-f361-4a21-aad1-282c2040b994/search?limit=5&page=1" | jq
...
2) Display the results using the next page URL::
    ...
    curl -sku <username:password> "https://<testing-instance>/api/2.0/urn:uuid:68320fee-f361-4a21-aad1-282c2040b994/search?q=&limit=5&page=2" | jq
